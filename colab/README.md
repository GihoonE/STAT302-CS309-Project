...
**Option B: Upload `colab` folder**
```python
import sys
sys.path.insert(0, "/content/...")  # path to parent of colab folder
```
...
```python
from colab import run_all_datasets
...
```python
from colab import run_pipeline_one
...
**cGAN Training:**
```python
from colab.cgan import build_gan_ds, build_generator, build_discriminator, train_cgan
